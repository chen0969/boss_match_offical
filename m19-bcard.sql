...
--
-- 傾印資料表的資料 `post_category_relation`
--
...
--
-- 資料表結構 `user_post_category_relations`
--
...
--
-- 傾印資料表的資料 `user_post_category_relations`
--
...
--
-- 傾印資料表的資料 `yizixue_faq_carousels`
--
...
--
-- 傾印資料表的資料 `yizixue_faq_categories`
--
...
--
-- 資料表索引 `about_us_carousels`
--
ALTER TABLE `about_us_carousels`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `about_us_contents`
--
...
--
-- 資料表索引 `qa_category_relation`
--
ALTER TABLE `qa_category_relation`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `qna_attachments`
--
ALTER TABLE `qna_attachments`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `question_answer`
--
ALTER TABLE `question_answer`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `service_agreements`
--
...
--
-- 資料表索引 `user_post_category_relations`
--
ALTER TABLE `user_post_category_relations`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `user_references`
--
...
--
-- 資料表索引 `yizixue_faq_carousels`
--
ALTER TABLE `yizixue_faq_carousels`
  ADD PRIMARY KEY (`id`);

--
-- 資料表索引 `yizixue_faq_categories`
--
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `about_us_carousels`
--
ALTER TABLE `about_us_carousels`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `about_us_contents`
--
ALTER TABLE `about_us_contents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `ad_columns`
--
ALTER TABLE `ad_columns`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `bulletin_board`
--
ALTER TABLE `bulletin_board`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `carousels`
--
ALTER TABLE `carousels`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `collect_post`
--
ALTER TABLE `collect_post`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `collect_qa`
--
ALTER TABLE `collect_qa`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `collect_user`
--
ALTER TABLE `collect_user`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `comment_qa`
--
ALTER TABLE `comment_qa`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `disclaimers`
--
ALTER TABLE `disclaimers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `like_posts`
--
ALTER TABLE `like_posts`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `like_users`
--
ALTER TABLE `like_users`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `member_agreements`
--
ALTER TABLE `member_agreements`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `pay_orders`
--
ALTER TABLE `pay_orders`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `pay_products`
--
ALTER TABLE `pay_products`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `phone_verifications`
--
ALTER TABLE `phone_verifications`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `post_category`
--
ALTER TABLE `post_category`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `privacies`
--
ALTER TABLE `privacies`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `qa_category`
--
ALTER TABLE `qa_category`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `qa_category_relation`
--
ALTER TABLE `qa_category_relation`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `qna_attachments`
--
ALTER TABLE `qna_attachments`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `question_answer`
--
ALTER TABLE `question_answer`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `service_agreements`
--
ALTER TABLE `service_agreements`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `subscription_agreements`
--
ALTER TABLE `subscription_agreements`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `university`
--
ALTER TABLE `university`
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `user_post_category_relations`
--
ALTER TABLE `user_post_category_relations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `user_references`
--
ALTER TABLE `user_references`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `user_skill_relation`
--
ALTER TABLE `user_skill_relation`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `yizixue_faqs`
--
ALTER TABLE `yizixue_faqs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `yizixue_faq_carousels`
--
ALTER TABLE `yizixue_faq_carousels`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `yizixue_faq_categories`
--
ALTER TABLE `yizixue_faq_categories`
